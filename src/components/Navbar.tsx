      ...
      <div className="lg:hidden block my-6">
        ...
        <Sheet>
          ...
          <ul className="flex flex-col items-center gap-4 mt-5 font-mono">
            <li className="cursor-pointer hover:underline">Plant pots</li>
            <li className="cursor-pointer hover:underline">Ceramics</li>
            <li className="cursor-pointer hover:underline">Tables</li>
            <li className="cursor-pointer hover:underline">Chairs</li>
            <li className="cursor-pointer hover:underline">Crockery</li>
            <li className="cursor-pointer hover:underline">Tableware</li>
            <li className="cursor-pointer hover:underline">Cutlery</li>
          </ul>
            <SheetFooter>
