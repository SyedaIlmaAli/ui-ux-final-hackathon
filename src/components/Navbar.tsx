      ...
      <div className="hidden lg:block">
        ...
        <div>
          <ul className="flex items-center justify-around mx-40 text-base">
            ...
            <Link href={"/productListing"}><li className="cursor-pointer hover:underline">Plant pots</li></Link>
            <Link href={"/productListing"}><li className="cursor-pointer hover:underline">Ceramics</li></Link>
            <Link href={"/productListing"}><li className="cursor-pointer hover:underline">Tables</li></Link>
            <Link href={"/productListing"}><li className="cursor-pointer hover:underline">Chairs</li></Link>
